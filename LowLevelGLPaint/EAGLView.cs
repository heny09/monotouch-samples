...
namespace LowLevelGLPaint
{
	public class EAGLView : UIView {
		...
		public void SwapBuffers ()
		{
			...
			if (!_context.EAGLContext.PresentRenderBuffer ((nuint)(uint) All.RenderbufferOes))
