...
namespace Xamarin.Screens.ViciCoolStorage
{
	public partial class BasicOperations : UITableViewController
	{
		...
		protected class TableSource : UITableViewSource
		{
			...
			public override nint NumberOfSections (UITableView tableView) { return (nint)1; }
			
			public override nint RowsInSection (UITableView tableview, nint section) { return (nint)this.items.Count; }
